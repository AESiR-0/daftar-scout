...
const questionsData = {
  defaultQuestions: [
    ...
    {
      id: 7,
      question: "Why should investors believe in your vision?", // Placeholder
...
export default function InvestorStudioPage() {
  ...
  const handleSaveQuestions = () => {
    if (selectedOption === "custom" && customQuestions.every((q) => q.question.trim() === "")) {
      toast({
    ...
    // TODO: Add API call to save questions
  };
                          ...
                          {questionsData.defaultQuestions.map((question) => (
                            <div
                              ...
                              className={`p-3 rounded-md cursor-pointer hover:bg-gray-700 transition-colors ${
                                selectedQuestion.id === question.id ? "bg-gray-700" : ""
                              }`}
                ...
                <div className="border-t border-gray-700 pt-6">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-medium">
                      {selectedOption === "sample" ? "Sample Questions" : "Custom Questions"}
                    </h3>
                    <Button
